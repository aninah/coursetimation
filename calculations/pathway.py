...
class Pathway(Concentration):
	def __init__(self, x, y, z, a, name):
		Concentration.__init__(self, x, y, z, a, name)
...
ai_ml = Pathway(4, [
	...
	pathway_names[1:], "", "artificial intelligence/machine learning")
theory = Pathway(5, [
	stats, 
	linear, 
	['CSCI 1010'], 
...
visual = Pathway(4, [
	...
	pathway_names[1:], "", "visual computing")
computer_arch = Pathway(3, [
	["CSCI 0330"], 
	["ENGN 1630", "ENGN 1640", "ENGN 1650"], 
	["ENGN 1630", "ENGN 1640", "ENGN 1650", "CSCI 1600", "CSCI 1760", "ENGN 1600"]], 
	pathway_names[2:], "", "computer architecture")
comp_bio = Pathway(5, [
	stats, 
	["CSCI 0220"], 
	["CSCI 1010"], 
	["CSCI 1810", "CSCI 1820"], 
	["CSCI 1810", "CSCI 1820", "CSCI 1420", "CSCI 1951A", "CLPS 1520"]], pathway_names, "", "computational biology")
design = Pathway(4, [
	stats, 
	["CSCI 0320", "CSCI 0330"],
