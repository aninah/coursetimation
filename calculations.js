...
class Concentration {
	constructor(num_classes, requirement_list, special_cases, additional_notes) {
...
let computer_science_scb = new Concentration(16, cs_scb);
console.log(computer_science_scb.how_many_satisfy(student_a));
